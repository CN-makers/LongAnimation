...
class CogVideoXDPMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        mean=mult[0] * sample - mult[1] * pred_original_sample
        var=mult_noise
        ...
        if old_pred_original_sample is None or prev_timestep < 0:
            ...
            return prev_sample, pred_original_sample,mean,var
        else:
            ...
            mean=mult[0] * sample - mult[1] * denoised_d 
            var=mult_noise
            #print(var)
        ...
        return DDIMSchedulerOutput(prev_sample=prev_sample, pred_original_sample=pred_original_sample,mean=mean,var=var)
